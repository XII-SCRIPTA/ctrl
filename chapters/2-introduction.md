...
Broadly construed, Bayesian approaches to cognitive modelling formalize the inferential processes of agents in terms of an \textbf{intuitive model}, specified in terms of a prior probability distribution that gets incrementally updated with new observations, generated by a data generating process. Optimal or rational solutions to a given inference problem are commonly modelled as the random variable with the highest posterior probability refp:Kemp-Tenenbaum:2007, refp:Icard:2014, refp:Griffiths2015.
